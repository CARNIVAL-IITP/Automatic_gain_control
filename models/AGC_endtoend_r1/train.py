...
def main(args):
    tr_dataset = AGCDataset(json_path = '/home/yhjeon/projects/IITP_SE/NS_AGC/data/SITEC_AGC/train.json', sample_rate=args.sample_rate, wav_len=args.wav_len, win_len=args.win_len, hop_len=args.hop_len)
    tr_dataloader = DataLoader(tr_dataset, batch_size = args.batch_size, shuffle=True, num_workers = args.num_workers)
    cv_dataset = AGCDataset(json_path = '/home/yhjeon/projects/IITP_SE/NS_AGC/data/SITEC_AGC/valid.json', sample_rate=args.sample_rate, wav_len=args.wav_len, win_len=args.win_len, hop_len=args.hop_len)
