...
class CosineAnnealingWarmupRestarts(_LRScheduler):
    ...
    def __init__(self,
        ...
        self.lr_init = warmup_lr_init if warmup_steps > 0 else max_lr
    ...
    def init_lr(self):
        for param_group in self.optimizer.param_groups:
            ...
            self.base_lrs.append(self.lr_init)
    ...
    def get_lr(self):
        if self.step_in_cycle == -1:
            ...
            return [base_lr + (self.max_lr - base_lr) * (1 + math.cos(math.pi * (self.step_in_cycle-self.warmup_steps)
